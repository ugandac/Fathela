...
zokou({
  ...
  try {
    ...
    if (_0x5a2825 && _0x5a2825.length > 0x0) {
      ...
      const _0x4727f9 = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url=" + encodeURIComponent(_0x50cb1f) + "&apikey=" + "gifted_api_kt5gd63gjd8");
...
zokou({
  ...
  try {
    ...
    if (_0x3f4e2c && _0x3f4e2c.length > 0x0) {
      ...
      const _0xfef402 = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url=" + encodeURIComponent(_0x13523a) + "&apikey=" + "gifted_api_kt5gd63gjd8");
...
zokou({
  ...
  try {
    ...
    if (_0x14ddfc && _0x14ddfc.length > 0x0) {
      ...
      const _0x5734dd = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url=" + encodeURIComponent(_0x1b41fa) + "&apikey=" + "gifted_api_kt5gd63gjd8");
...
zokou({
  ...
  try {
    ...
    if (_0x5914b4 && _0x5914b4.length > 0x0) {
      ...
      const _0x1ee242 = await fetch("https://api.giftedtech.web.id/api/download/dlmp3?url=" + encodeURIComponent(_0x5225ee) + '&apikey=' + "gifted_api_kt5gd63gjd8");
